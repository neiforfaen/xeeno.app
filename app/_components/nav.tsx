...
export const Navbar = () => {
  ...
  const toggleMenuOpen = useCallback(() => setOpen(!isOpen), [isOpen])
    ...
    <header className="fixed top-0 left-0 z-40 w-full bg-background">
      <div className="container relative mx-auto flex min-h-20 flex-row items-center gap-4 lg:grid lg:grid-cols-3">
        ...
        <div className="flex w-full justify-end gap-4">
          ...
          <Button onClick={handleSignupRedirect}>Get started</Button>
        </div>
        <div className="flex w-12 shrink items-end justify-end lg:hidden">
          <Button onClick={toggleMenuOpen} variant="ghost">
